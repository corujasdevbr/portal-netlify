...
export default function RightPanelDataBusiness(props) {
        ...
        <div className="scroll dashboard-list-with-thumbs">
          ...
          >
            ...
            <div className="pl-3 pt-2 pr-2 pb-2">
                      ...
                      {"Company Name"}<p className="list-item-heading">{data[0].companyName}</p>
                      {"Topic Name"}<p className="list-item-heading">{data[0].topicName}</p>
