...
import RatingFeedbackPrefilled from "../../containers/forms/RatingFeedbackPrefilled";
export default function RightPanelDataForPayment(props) {
  return (
        ...
        <div className="scroll dashboard-list-with-thumbs">
          ...
          >
            ...
            <div className="pl-3 pt-2 pr-2 pb-2">
                      ...
                      {"Transaction Date"}<p className="list-item-heading">{data[0].transactionDate}</p>
                      {"Transaction Id"}<p className="list-item-heading">{data[0].transactionId}</p>
                      {"Transaction Amount"}<p className="list-item-heading">{data[0].transactionAmount}</p>
                    ...
                    <RatingFeedbackPrefilled/> 
                    {"Feedback Content"}<p className="list-item-heading">{data[0].feedbackContent}</p>
                    {/* <Input
                        type="text"
