...
const dataTableColumns = [
  ...
  },
  {
    Header: "Info",
    accessor: "infoColor",
    Cell: props => <p className="list-item-heading">{props.value == 'green'?<div class="glyph-icon simple-icon-info"></div>:<div class="glyph-icon iconsminds-information"></div>}</p>
  }
];
...
export const ReactTableAdvancedCardForPayment = props => {
  return (
    <Card className="mb-4">
      <CardBody>
        <CardTitle>
