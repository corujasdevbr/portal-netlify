...
import RightPanelDataForPaymentBusiness from '../../../containers/dashboards/RightPanelDataForPaymentBusiness';
...
class BusinessPaymentListPages extends Component {
  render() {
      ...
      <Fragment>
        ...
        <Colxx lg="12" xl="8" className="mb-4">
         ...
         <Colxx lg="12" xl="4" className="mb-4">
            <RightPanelDataForPaymentBusiness listData={this.props.rowInfo}/>
          </Colxx>
       </Row>
...
export default injectIntl(BusinessPaymentListPages);
