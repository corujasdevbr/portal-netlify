...
const EditorProjectListPages = React.lazy(() =>
  import(/* webpackChunkName: "editor-myproject-project-list" */ './project-list')
);
    ...
    <Switch>
      ...
      />
       <Route
        ...
        render={props => <EditorProjectListPages {...props} />}
      />
      <Route
