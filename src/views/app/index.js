...
const Dashboard = React.lazy(() =>
    import(/* webpackChunkName: "dashboard" */ './menu')
)
...
const EditorMyProject = React.lazy(() =>
    import(
        /* webpackChunkName: "editor-myproject-default" */ './editor-myprojects'
    )
)
...
const BusinessDashboards = React.lazy(() =>
    import(
        /* webpackChunkName: "business-dashboards" */ './business-dashboards'
    )
)

const BusinessMyProject = React.lazy(() =>
    import(
        /* webpackChunkName: "business-myproject-default" */ './business-myprojects'
    )
)
