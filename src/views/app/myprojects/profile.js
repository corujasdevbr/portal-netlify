...
class Profile extends Component {
    ...
    onClickNext(goToNext, steps, step) {
        ...
        let phone = this.state.fields[formIndex].phone;
        let gender = this.state.fields[formIndex].gender;
        let password = this.state.fields[formIndex].password;
        form.submitForm().then(() => {
            let fields = this.state.fields;
            fields[formIndex].value = form.state.values[name];
            fields[formIndex].value = form.state.values[phone];
            fields[formIndex].value = form.state.values[password];
            fields[formIndex].valid = form.state.errors[name] && form.state.errors[phone] && form.state.errors[password] ? false : true;
            this.setState({ fields });
            if (!form.state.errors[name] && !form.state.errors[phone] && !form.state.errors[password]) {
                goToNext();
                step.isDone = true;
            ...
            <Card>
                <CardBody className="wizard wizard-default">
                    <Wizard>
                        ...
                        <Steps>
                            <Step id="step1" name={messages["wizard.step-name-1"]} desc={messages["wizard.personal-details"]}>
                                <div className="wizard-basic-step">
                                    <Formik
                                        ref={this.form0}
                                        initialValues={{
                                            name: this.state.fields[0].value,
                                            phone: this.state.fields[1].value,
                                        ...
                                        {({ errors, touched }) => (
                                            <Form className="av-tooltip tooltip-label-right">
                                                ...
                                                <FormGroup>
                                                    <Label>{messages["forms.phone"]}</Label>
                                                    <Field
                                                        className="form-control"
                                                        name="phone"
                                    ...
                                    <Formik
                                        ...
                                        {({ errors, touched }) => (
                                            <Form className="av-tooltip tooltip-label-right error-l-75">
                                                <FormGroup>
                                                    <Label>{messages["forms.occupation"]}</Label>
                                                    <Field
                                                        className="form-control"
                                                        name="occupation"
                                                        validate={this.validateOccupationl}
                                                    />
